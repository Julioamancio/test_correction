...
def list_questions():
    ...
    return render_template_string('''
        ...
        <a href="{{ url_for('import_questions') }}">Import .docx</a> |
        <a href="{{ url_for('logout') }}">Logout</a>
        <ul>
        {% for q in qs %}
            <li>{{ q.text[:50] }} - <img src="{{ url_for('uploaded_file', filename=q.image_filename) }}" height="50" />
            </li>
        {% endfor %}
        </ul>
    ''', qs=qs)
...
def new_question():
    ...
    return render_template_string('''
        <form method="post" enctype="multipart/form-data">
            <textarea name="text" placeholder="Question text"></textarea><br>
            <input name="option_a" placeholder="A"/><br>
            <input name="option_b" placeholder="B"/><br>
            <input name="option_c" placeholder="C"/><br>
            <input name="option_d" placeholder="D"/><br>
            <input name="option_e" placeholder="E"/><br>
            Correct option: <input name="correct"/><br>
            Classification: <input name="classification"/><br>
